const snakeTable = document.querySelector(".snakeTable");
...
// random 'food'
function randomFood() {
  const randomX = Math.floor(Math.random() * table.rowsCols);
  const randomY = Math.floor(Math.random() * table.rowsCols);
